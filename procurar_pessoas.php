	...
	<body>
	    ...
	    <div class="container">
            ...
            <div class="col-md-6">
					<div class="panel panel-default">
						<div class="panel-body">
							<form id="form_procurar_pessoas" class="input-group">
								<input type="text" id="nome_pessoa" name="nome_pessoa" method ="POST" class="form-control" placeholder="Digite um nome de usuario" maxlength="140">
								<span class="input-group-btn">
									<button type="button" class="btn btn-default" id="btn_procurar" name="btn_procurar">Buscar</button>
								</span>
                        </form>                 
						</div>
					...
					<div id="amigos" class="list-group">
