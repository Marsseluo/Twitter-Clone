...
include 'global.php';
	...
	$erro_usuario = isset($_GET['erro_usuario']) ? ($_GET['erro_usuario']) : 0; //teste ternário 
	$erro_email = isset($_GET['erro_email']) ? ($_GET['erro_email']) : 0;  // if ternário
	    	...
	    	<div class="col-md-4">
				...
				<form method="post" action="registra_usuario.php" id="formCadastrarse">
					<div class="form-group">
						...
						<?php 
						if($erro_usuario){ // 1 = true , 2 = false
					...
					<div class="form-group">
						...
						<?php 
						if($erro_email){
							echo "<font style='color:red'> Email já existe </font>";
						}
						?>
